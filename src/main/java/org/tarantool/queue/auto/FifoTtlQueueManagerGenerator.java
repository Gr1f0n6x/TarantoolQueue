...
final class FifoTtlQueueManagerGenerator extends TtlQueueManagerGenerator implements PutWithOptions, ReleaseWithOptions {
    ...
    protected TypeSpec.Builder queueBuilder(TypeSpec metaSpec) {
        ...
        builder
                ...
                .addMethod(generatePutWithOptions(TtlBuilder.class, queueMeta))
                .addMethod(generateReleaseWithOptions(TtlBuilder.class, queueMeta));

        return builder;
    }

    static class PutOperationBuilderGenerator implements Ttl, Ttr, Delay, Priority {
        ...
        public TypeSpec generate() {
            TypeName typeName = ParameterizedTypeName.get(ClassName.get(TtlBuilder.class), queueMeta.classType);
    ...
    static class ReleaseOperationBuilderGenerator implements Ttl, Ttr, Delay, Priority {
        private final QueueMeta queueMeta;
        private final TypeName operationResultType;
