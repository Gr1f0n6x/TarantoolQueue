...
final class UtubeTtlQueueManagerGenerator extends TtlQueueManagerGenerator implements PutWithOptions, ReleaseWithOptions {
    ...
    static class PutOperationBuilderGenerator implements Ttl, Ttr, Delay, Priority, Utube {
    ...
    static class ReleaseOperationBuilderGenerator implements Ttl, Ttr, Delay, Priority, Utube {
        private final QueueMeta queueMeta;
        private final TypeName operationResultType;
